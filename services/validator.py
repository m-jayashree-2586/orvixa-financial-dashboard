...
class Validator:
    ...
    def validate_age(age: int) -> None:
        ...
        Raises:
            ValueError: If age is missing or outside the supported 
                range of 16 to 100 years.
        """
        if age is None:
    ...
    @staticmethod
    def validate_occupation(occupation: str) -> None:
        """Validates that an occupation is present and non-blank.
 
        Args:
            occupation: The user's occupation.
 
        Raises:
            ValueError: If occupation is empty or whitespace only.
        """
